...
namespace Kahnadex {
	namespace XML {
		...
		inline int XmlAttributeList::Count() {
		...
		public:
			...
			//methods
		private:
			void              CreateChildrenFromInnerText();
			void              Render(string& as_Output);
		public:
		...
		inline XmlAttributeList& XmlNode::Attributes() {
			return(mh_Attributes);
		}
		inline XmlNodeList& XmlNode::ChildNodes() {
		...
		inline XmlDocumentType XmlDocument::DocumentType() {
			return(me_DocType);
		}
