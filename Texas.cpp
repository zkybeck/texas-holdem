...
//------------------------------------------
void TexasHoldem::ProcessBets(void)
{
	int i;
...
//------------------------------------------
void TexasHoldem::ProcessStateDealt(void)
{
	int i;
	char c;
	...
	printf("The Flop:\n%s%c | %s%c | %s%c\n",CardDeck::GetCardNameShort(flop1->Type),flop1->Suit,CardDeck::GetCardNameShort(flop2->Type),flop2->Suit,CardDeck::GetCardNameShort(flop3->Type),flop3->Suit);

	me_State = THSE_FLOP;
	return;
}
//------------------------------------------
void TexasHoldem::ProcessStateFlop(void)
{
	int i;
	...
	printf("The Turn:\n%s%c | %s%c | %s%c | %s%c\n",CardDeck::GetCardNameShort(flop1->Type),flop1->Suit,CardDeck::GetCardNameShort(flop2->Type),flop2->Suit,CardDeck::GetCardNameShort(flop3->Type),flop3->Suit, CardDeck::GetCardNameShort(turn->Type),turn->Suit);
	me_State = THSE_TURN;

	return;
}
//------------------------------------------
void TexasHoldem::ProcessStateNone(void)
{
	int  i;
	Bet* b;
	...
	printf("Deck shuffled. Your Cards:\n%s%c | %s%c\n\n",CardDeck::GetCardNameShort(p1c1->Type),p1c1->Suit, CardDeck::GetCardNameShort(p1c2->Type),p1c2->Suit);
	me_State = THSE_DEALT;
	return;
}
//------------------------------------------
void TexasHoldem::ProcessStateRiver(void)
{
	int i;
	...
	for(i=0;i<mv_Players.size();i++){			
		...
		printf("%dUP(%s): %s%c | %s%c\n->%s\n",i+1,title,CardDeck::GetCardNameShort(p1c1->Type),p1c1->Suit,CardDeck::GetCardNameShort(p1c2->Type),p1c2->Suit,mv_Players[i]->Hand().HandName());
	}
...
//------------------------------------------
void TexasHoldem::ProcessStateTurn(void)
{
	int i;
	//signal the next betting player 
	//this will change of course, depending on who stays in
	...
	printf("The River:\n%s%c | %s%c | %s%c | %s%c | %s%c\n\n",CardDeck::GetCardNameShort(flop1->Type),flop1->Suit,CardDeck::GetCardNameShort(flop2->Type),flop2->Suit,CardDeck::GetCardNameShort(flop3->Type),flop3->Suit, CardDeck::GetCardNameShort(turn->Type),turn->Suit,CardDeck::GetCardNameShort(river->Type),river->Suit);
	me_State = THSE_RIVER;
	return;
}
//------------------------------------------
void TexasHoldem::RotateDealerButton(void)
{
