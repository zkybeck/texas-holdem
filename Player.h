...
public:
	...
	//methods
public:
	int ChipCount() { return mi_ChipCount; }
	static bool ComparePlayer(const Player* a, const Player* b) {
		return a->mi_PlayerID < b->mi_PlayerID;
	}
	PokerHand& Hand() { return mh_Hand; }
	bool IsComputer() { return me_PlayerType == PT_HUMAN; }
	int Losses() { return mi_Losses; }
	int Ties() { return mi_Ties; }
	int Wins() { return mi_Wins; }
