...
class TexasHoldem : public Poker
{
	...
	//methods
	private:
		void  ProcessBets(void);
		void  ProcessStateDealt(void);
		void  ProcessStateFlop(void);
		void  ProcessStateNone(void);
		void  ProcessStateRiver(void);
		void  ProcessStateTurn(void);
		void  RotateDealerButton(void);
	public:
